...
await copyFile('./scripts/dist/client/addon/preset.mjs', './dist/client/addon/preset.mjs');
await copyFile('./scripts/dist/client/addon/preview.mjs', './dist/client/addon/preview.mjs');
