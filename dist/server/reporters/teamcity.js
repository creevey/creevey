...
exports.TeamcityReporter = void 0;
        ...
        runner.on(types_js_1.TEST_EVENTS.TEST_FAIL, (test, error) => {
            ...
            Object.entries(test.creevey.images).forEach(([name, image]) => {
                ...
                Object.values(rest)
                    ...
                    console.log(`##teamcity[testMetadata type='image' value='report/${filePath}/${fileName}' flowId='${flowId}']`);
                });
            });
            console.log(`##teamcity[testFailed name='${testName}' message='${this.escape(messageStr)}' details='${this.escape(detailsStr)}' flowId='${flowId}' duration='${duration}']`);
            console.log(`##teamcity[testFinished name='${testName}' flowId='${flowId}' duration='${duration}']`);
            for (const title of testPath.reverse()) {
                console.log(`##teamcity[testSuiteFinished name='${title}' flowId='${flowId}']`);
            }
