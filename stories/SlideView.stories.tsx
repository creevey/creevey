...
export const _100x100_vs_100x100: Story = () => (
  <SlideView expect={'?width=100&height=100'} diff={'?width=100&height=100'} actual={'?width=100&height=100'} />
);
export const _100x100_vs_2000x100: Story = () => (
  <SlideView expect={'?width=100&height=100'} diff={'?width=2000&height=100'} actual={'?width=2000&height=100'} />
);
export const _100x100_vs_100x2000: Story = () => (
  <SlideView expect={'?width=100&height=100'} diff={'?width=100&height=2000'} actual={'?width=100&height=2000'} />
);
export const _100x100_vs_2000x2000: Story = () => (
  <SlideView expect={'?width=100&height=100'} diff={'?width=2000&height=2000'} actual={'?width=2000&height=2000'} />
);
export const _2000x100_vs_100x2000: Story = () => (
  <SlideView expect={'?width=2000&height=100'} diff={'?width=2000&height=2000'} actual={'?width=100&height=2000'} />
);
export const _2000x100_vs_2000x2000: Story = () => (
  <SlideView expect={'?width=2000&height=100'} diff={'?width=2000&height=2000'} actual={'?width=2000&height=2000'} />
);
export const _100x2000_vs_2000x2000: Story = () => (
  <SlideView expect={'?width=100&height=2000'} diff={'?width=2000&height=2000'} actual={'?width=2000&height=2000'} />
);
export const _2000x2000_vs_2000x2000: Story = () => (
  <SlideView expect={'?width=2000&height=2000'} diff={'?width=2000&height=2000'} actual={'?width=2000&height=2000'} />
);
